...
def main():
    ...
    if pdf:
        ...
        if(query):
            ...
            # llm = HuggingFaceHub(
            #     repo_id="NousResearch/Llama-2-7b-chat-hf",  # Replace with the desired model
            #     model_kwargs={"temperature": 0.5, "max_length": 512},
            #     huggingfacehub_api_token=HUGGINGFACE_API_TOKEN
            #     # task="text-generation"  # Set the correct task according to the model
            # )

            llm = AutoModelForCausalLM.from_pretrained("deepseek-ai/DeepSeek-R1-Distill-Llama-8B", device_map="auto")  
